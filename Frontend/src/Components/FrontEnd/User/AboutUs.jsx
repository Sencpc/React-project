        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-3 text-gray-600">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <a
                    href="https://wa.me/6289854525596"
                    target="_blank"
                    rel="noreferrer"
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-900 leading-relaxed">
                    Jl. Gubeng Kertajaya V F Blok F No.32
                  </p>
                  <p className="text-sm text-gray-600">
                    RT.007/RW.03, Airlangga, Kec. Gubeng
                  </p>
                  <p className="text-sm text-gray-600">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-gray-900">Sosial Media</h3>
            </div>
            <div className="space-y-3">
              <a
                href="https://www.instagram.com/sebastiantjandra?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-3 p-3 rounded-lg hover:bg-gradient-to-r hover:from-purple-50 hover:to-pink-50 transition-all duration-300 group"
              >
